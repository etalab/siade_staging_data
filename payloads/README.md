...
* [Identité] Statut service civique (`/v3/gip_mds/service_civique/identite`)
* [FranceConnect] Statut service civique (`/v3/gip_mds/service_civique/france_connect`)
...
* Données établissement (`/v4/insee/sirene/etablissements/{siret}`)
...
* Données établissement en open data (`/v4/insee/sirene/etablissements/diffusibles/{siret}`)
...
* Données siège social en open data (`/v4/insee/sirene/unites_legales/diffusibles/{siren}/siege_social`)
* [Données siège social](api_entreprise_v3_insee_sieges_unites_legales) (`/v3/insee/sirene/unites_legales/{siren}/siege_social`)
* Données siège social (`/v4/insee/sirene/unites_legales/{siren}/siege_social`)
...
* Données unité légale (`/v4/insee/sirene/unites_legales/{siren}`)
...
* Données unité légale en open data (`/v4/insee/sirene/unites_legales/diffusibles/{siren}`)
